...
* Dans *Argument*, la commande est :
  ```ps
  -ExecutionPolicy RemoteSigned -file "C:\SWMB\Win10-Initial-Setup-Script\Win10.ps1" -include "C:\SWMB\Modules\SWMB.psm1" -preset "C:\SWMB\Presets\UserExperience-Resinfo.preset"
  ```
