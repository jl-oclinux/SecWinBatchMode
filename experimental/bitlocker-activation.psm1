...
#sauvegarde des cl�s sur un chemin r�seau
...
# On traite toutes les partitions qui ont une lettre associ�e et qui sont de type fixed
# ie on ne prend pas en compte les cl�s usb
...
do {
    ...
    if ($volume.DriveLetter) {
        ...
        if ($ChiffDrv -eq "Y") {
			...
			##TODO
			#A voir pourquoi on reteste pas si partition d�j� chiffr�e (comme pour C:)
			#A rajouter copie de la cl� sur r�seau si $networkKeyBackupFolder = true
            ...
            #if ($NextVolume -ne 'O'){
            #Write-Host "Chiffrement BitLocker termin� pour tous les lecteurs"
            #exit
            #}
